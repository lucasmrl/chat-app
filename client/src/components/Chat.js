...
function Chat() {
  ...
  return (
    <div className="flex w-screen min-h-full md:h-screen bg-gray-900 divide-solid">
      <div className="flex w-full min-h-full md:w-5/6 md:h-5/6 md:mx-auto md:my-auto shadow-md">
        {/* Users online */}
